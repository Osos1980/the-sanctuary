...
import datetime
import pytz  # Handles the Central Time conversion
import random
import os
...
# This ensures the "Morning/Evening" and "Friday" logic follows Jessica in TN/TX
...
new_task = st.text_input("Enter a custom objective:", placeholder="Enter manual task...", label_visibility="collapsed")
...
# --- 8. MISSION LOG (CENTRAL TIME DAY CHECK) ---
st.write("---")
...
st.sidebar.metric("Points", f"{st.session_state.points} pts")
